...
from jarvis.gui.components.nav_bar import NavBar
from jarvis.gui.components.left_panel import LeftPanel
from jarvis.gui.components.center_panel import CenterPanel
from jarvis.gui.components.right_panel import RightPanel
...
class JarvisMainWindow(QMainWindow):
    ...
    def _connect_events(self):
        ...
        mappings = {
            ...
            "JARVIS_RESPONSE":   self._on_jarvis_response,
    ...
    async def _on_jarvis_response(self, data: dict):
        ...
        self.center_panel.transcript.add_text(data["text"], "JARVIS")
